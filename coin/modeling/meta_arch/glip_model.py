...
if not os.path.exists('./nltk_data/tokenizers/punkt'):
    print('start downloading nltk_data punkt')
    nltk.download('punkt', download_dir='./nltk_data')
if not os.path.exists('./nltk_data/taggers/averaged_perceptron_tagger'):
    print('start downloading nltk_data averaged_perceptron_tagger')
    nltk.download('averaged_perceptron_tagger', download_dir='./nltk_data')

import timeit

'''copy from GLIP with minor modify.'''
